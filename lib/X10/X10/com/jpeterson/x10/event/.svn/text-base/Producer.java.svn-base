...
/**
 * Producers fire events to AddressListeners and FunctionListeners. An example
 * of a producer may be a software widget that represents a light switch. When
 * the switch is turned on, the registered AddressListeners and
 * FunctionListeners will be notified. For actual transmission of an X10Event
 * through a gateway, it may be desirable to use the Transmitter interface.
 * 
