...
/**
 * An X10 event represents an X10 transmission packet. This is the base class
 * for subclasses that implement the different X10 messages.
 * 
 * @version 1.0
...
public class X10Event extends EventObject {
	 ...
	 *            The number of dims.
	 * @param function
	 *            True if the event is a function event, false if the event is
	 *            an address event.
	 * @param extended
	 *            True if the event is an extended event, false otherwise
	 * @param hiNibble
	 *            The upper four bits of the 'Code' portion of the X10 event.
	 *            This is usually the housecode
	 * @param loNibble
	 *            The lower four bits of the 'Code' portion of the X10 event.
	 *            This is typically the device code in an address event or the
	 *            function code in a function event.
	 * @param dimMax
	 *            The maximum number of dims for the event.
	 */
	public X10Event(Object source, int dims, boolean function,
			boolean extended, byte hiNibble, byte loNibble, int dimMax) {
	...
	/**
	 * Create an X10 event. This constructor is normally used for standard
	 * address and function events that do not have dim values or extended
	 * characteristics. It is provided for convenience. The maximum number of
	 * dims is 22.
	 * 
	 * @param source
	 *            The event source.
	 ...
	 * 
	 * @return Array of bytes that constitute the payload of the X10 event. For
	 *         standard events, the array will have a size of 2. For extended
	 *         events, the size will be 4.
	 */
	...
	/**
	 * Retrieve the high nibble of the 'code' portion of the packet. This is the
	 * 'housecode'.
	 * 
	...
	/**
	 * Retrieve the low nibble of the 'code' portion of the packet. This is the
	 * 'device code' for address messages or the 'function' for function
	 * messages.
	 * 
	...
	public boolean equals(Object object) {
		...
		if (object == null || !(object instanceof X10Event))
			return false;
		...
		if (dims == target.getDims() && function == target.isFunction()
