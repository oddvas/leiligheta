...
public class TimerInitiator implements Serializable {
	...
	/**
	 * Create a new TimerInitiator. Initialized with start date set to January 1
	 * and stop date set to December 31.
	 */
	 ...
	 *         number of elements in the array indicate the number of days set.
	 ...
	 *         <CODE>Calendar.SATURDAY</CODE>. The
	 * @see java.util.Calendar
	 */
	...
	/**
	 * Set the start date for this TimerInitiator. The day of the week and day
	 * of the year are anded together, so both have to match the current time
	 * before the event will trigger a macro.
	 * 
	 * @param month
	...
	/**
	 * Set the start time for this TimerInitiator. Event is triggered if current
	 * day is within window of start day and stop day, and current time matches
	 * this time.
	 * 
	 * @param hour
	 *            Hour in 24 hour time, 0 - 23. Example: 14 = 2 PM.
	 * @param minute
	 *            Minute, 0 - 59.
	 */
	...
	/**
	 * Set the stop day for this TimerInitiator. The day of the week and day of
	 * the year are anded together, so both have to match the current time
	 * before the event will trigger a macro.
	 * 
	 * @param month
	 *            Month, zero based. e.g., 0 for January, 1 for February.
	...
	/**
	 * Set the stop time for this TimerInitiator. Event is triggered if current
	 * day is within window of start day and stop day, and current time matches
	 * this time.
	 * 
	 * @param hour
	...
	/**
	 * Set the start macro. Triggered at the start time if current day is is
	 * within the start day and stop day and the day of the week is set.
	 * 
	 * @param macro
	 *            Macro to invoke.
	 */
	...
	/**
	 * Set the stop macro. Triggered at the stop time if current day is is
	 * within the start day and stop day and the day of the week is set.
	 * 
	 * @param macro
	 *            Macro to invoke.
	 ...
	 * 
	 * @param startMacroOffset
	 *            Integer offset to start macro to initiate.
	 * @param stopMacroOffset
