...
public class MacroInitiator implements Serializable {
	 ...
	 * @param function
	 *            An OnEvent that designates that the macro will execute. The
	 *            OnEvent contains the house code that this MacroInitiator is
	 *            assigned to as well. For proper use with a macro, the source
	 ...
	 *            Device number. Must be between 1 and 16, inclusive.
	 * @param function
	 *            An OffEvent that designates that the macro will execute. The
	 *            OffEvent contains the house code that this MacroInitiator is
	 *            assigned to as well. For proper use with a macro, the source
	...
	/**
	 * Return the function assigned to this MacroInitiator. Will be an OnEvent
	 * or an OffEvent.
	 * 
	 ...
	 * 
	 * @param macroOffset
	 *            Integer offset to macro to initiate.
