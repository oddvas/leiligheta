...
public class Macro implements Serializable {
	 ...
	 * 
	 * @param timerOffset
	 *            Offset in minutes from the time at which the macro is called
	 *            to the time when the macro actually takes effect. 0 to 240
	 *            minutes (4 hours).
	 * @exception IllegalArgumentException
	 *                Thrown if timer offset is less than 0 or greater than 240.
	 */
	public Macro(int timerOffset) {
		if (timerOffset < 0 || timerOffset > 240)
			throw new IllegalArgumentException(
					"Macro timer offset minutes must be between 0 and 240");
	...
	/**
	 * Add a command for this macro to execute. When the macro is executed, this
	 * command will be carried out. The house code for the address and function
	 * must both be the same. The maximum number of commands is 255. Commands
	 * added after 255 are silently ignored.
	 * 
	 * 
	 * @param device
	 *            Device number. Must be between 1 and 16, inclusive.
	 * @param function
	 *            A FunctionEvent for a command that the macro will execute. For
	 *            proper use in this case for a macro, the source of the
	 *            X10Event will be ignored.
	 * @exception IllegalArgumentException
	 *                Thrown if the device number is less than 1 or greater than
	 *                16.
	 */
	 ...
	 *            X10Event will be ignored.
	 * @param brightenFirst
	 *            If true and Functin Event is a dim or bright command, the
	 *            device will be brought to maximum brightness before applying
	 *            the dim amount. This functionality is global per dim/bright
	 *            command per macro. It is updated each time a device is added.
	 * @exception IllegalArgumentException
	 *                Thrown if the device number is less than 1 or greater than
	 *                16.
	 */
	public synchronized void addCommand(int device, FunctionEvent function,
			boolean brightenFirst) throws IllegalArgumentException {
	...
	/**
	 * Add a command for this macro to execute. When the macro is executed, this
	 * command will be carried out. The maximum number of commands is 255.
	 * Commands added after 255 are silently ignored.
	 * 
	 * @param function
	 *            A FunctionEvent command that the macro will execute. For
	 *            proper use in this case for a macro, the source of the
	 *            X10Event will be ignored.
	 */
	...
	/**
	 * This method provides a way to remove a macro element from the macro. You
	 * can retrieve all of the macro elements in this macro from the
	 * <CODE>elements</CODE> method.
	 * 
	 * @param element
	 *            the macro element to remove.
	 */
	 ...
	 * 
	 * @param object
	 *            Target object to determine if it is equal to this Macro.
	...
	public boolean equals(Object object) {
		...
		if (timerOffset == target.getTimerOffset()) {
			...
			// check to see that the target contains all of this macro's
			// elements
