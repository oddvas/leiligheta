 ...
 * <CODE>TransmitterListener</CODE> objects are attached to and removed from a
 * <CODE>Transmitter</CODE> by calling the <CODE>addGatewayListener</CODE> and
 * <CODE>removeGatewayListener</CODE> methods (which <CODE>Transmitter</CODE>
 * inherits from the <CODE>Gateway</CODE> interface.
 * <P>
...
public abstract interface TransmitterListener extends EventListener {
	 ...
	 * output queue has changed. The <CODE>Transmitter</CODE> is in the
	 * <CODE>QUEUE_NOT_EMPTY</CODE> state.
	 * 
	 */
