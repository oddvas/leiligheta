...
public class X10Util {
	 ...
	 * 
	 * @param houseCode
	 *            character representation of the house code; 'A' - 'P'
	 * @return Value of house code
	 * @exception IllegalArgumentException
	 *                Thrown if the house code not equal to 'A'-'P'.
	 */
	 ...
	 * 
	 * @param nibble
	 *            the house code value.
	 * @return Character 'A' through 'P' that corresponds to the house code
	 *         value.
	 */
	 ...
	 * 
	 * @param deviceCode
	 *            numeric representation of the device code; 1 - 16
