...
/**
 * Signals an error caused by an illegal call to a method of a gateway. For
 * example, it is illegal to request a deallocated <CODE>Trasnmitter</CODE> to
 * transmit or to request any deallocated gateway to pause or resume.
 * 
