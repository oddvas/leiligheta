...
/**
 * <CODE>GatewayErrorEvent</CODE> is an asynchronous notification of an internal
 * error in the gateway which prevents normal behavior of that gateway. The
 * event encapsulates a <CODE>Throwable</CODE> object that provides details
 * about the rror.
 * 
...
public class GatewayErrorEvent extends GatewayEvent {
	 ...
	 * throwable, old gateway state and new gateway state. The old and new
	 * states are zero if the gateway states are unknown or undefined.
	 * 
	 * @param source
