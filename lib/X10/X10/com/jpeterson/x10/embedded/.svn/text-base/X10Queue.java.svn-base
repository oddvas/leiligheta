...
/**
 * Implements a simple FIFO queue. If no queue elements when <code>get</code> is
 * called, method will wait till a <code>put</code> is performed.
 * 
...
public class X10Queue {
	 ...
	 * 
	 * @param initCapacity
	 *            Initial number of free slots in the queue. Will grow to
	 *            support more elements as needed.
	 */
	 ...
	 * 
	 * @param obj
	 *            Object to put end of the queue.
	 */
