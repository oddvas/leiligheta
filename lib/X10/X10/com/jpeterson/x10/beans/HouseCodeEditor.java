...
public class HouseCodeEditor extends PropertyEditorSupport {
	 ...
	 * 
	 * @param o
	 *            Character object representing the house code
	 */
	@Override
	 ...
	 * 
	 * @param s
	 *            House code as a String representation
	 */
	@Override
	 ...
	 * Get the string tags
	 * 
	 * @return Return a string of all of the possible house codes to choose from
	 */
	@Override
