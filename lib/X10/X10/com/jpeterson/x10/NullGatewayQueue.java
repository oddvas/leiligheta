 ...
 * <code>put</code> method directly calls the dispatcher to dispatch the
 * message. This type of handling is useful for embedded type of applications
 * that do not require their event notification to be synchronized with other
 * events.
 * 
...
public class NullGatewayQueue extends GatewayQueue {
	 ...
	 * Because it directly calls the dispatcher on the current thread, there is
	 * no decoupling or synchronization performed.
	 * 
	 * @param event
